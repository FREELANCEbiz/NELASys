...
import static app.view.coa.AddAccount.frmParent;
...
public class EditAccount extends javax.swing.JDialog {
    ...
    public EditAccount(MainFrameCoa parent, boolean modal) {
        this.frmParent = parent;
        this.setModal(modal);
        initComponents();
        setLocationRelativeTo(this);
        getRootPane().setDefaultButton(cmdadd);
        Controller.setCOAId(id);
        Controller.PopulateDataOnEdit();
        PopulateFields();
    }

    void PopulateFields() {
        txtcode.setText(Controller.getAccountCode());
        txttitle.setText(Controller.getAccountTitle());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditAccount dialog = new EditAccount(frmParent, true);
