 ...
 * @author Engkoi Zidac
 */
public final class MainFrameCoa extends javax.swing.JInternalFrame {

    public static AddAccount frmNew;
    public static EditAccount frmEdit;
    ...
    public void ShowFrmEdit() {
        frmEdit = new EditAccount(this, true);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtsearch, javax.swing.GroupLayout.DEFAULT_SIZE, 446, Short.MAX_VALUE)
                .addGap(21, 21, 21))
        );
    ...
    private void AddButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton1ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            EditAccount.id = Short.valueOf(id);
            ShowFrmEdit();
        }
    ...
    private void AddButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButton2ActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            switch (i) {
                case 0:
                    Controller.setCOAId(Integer.valueOf(id));
                    Controller.Remove();
                    PopulateData();
