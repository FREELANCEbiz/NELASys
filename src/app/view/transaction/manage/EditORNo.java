 ...
 * @author Engkoi Zidac
 */
public class EditORNo extends javax.swing.JDialog {
    ...
    public EditORNo(ManageTrans parent, boolean modal) {
    ...
    void CreateLog(){
        LogController.setDetails("Edit: Voucher/OR Number changed from "+ ref+ " to "+ txtor.getText());
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(txtor, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditORNo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditORNo dialog = new EditORNo(frmParent, true);
