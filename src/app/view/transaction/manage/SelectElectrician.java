 ...
 * @author Engkoi Zidac
 */
public class SelectElectrician extends javax.swing.JDialog {

    public static EditElectrician frmParent;
    ElectricianController Controller = new ElectricianController();

    public SelectElectrician(EditElectrician parent, boolean modal) {
    ...
    private void cmdaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdaddActionPerformed
        ...
        if (Table.isRowSelected(row) != true) {
            ...
            String nym = Table.getValueAt(row, 1).toString();
            frmParent.SelectElectrician(Integer.parseInt(id), nym);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectElectrician.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectElectrician dialog = new SelectElectrician(frmParent, true);
