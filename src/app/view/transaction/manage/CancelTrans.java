 ...
 * @author Engkoi Zidac
 */
public class CancelTrans extends javax.swing.JDialog {
    ...
    public CancelTrans(ManageTrans parent, boolean modal) {
    ...
    void CreateLog() {
        LogController.setDetails("Cancel: Transaction cancelled due to " + txtreason.getText());
    ...
    private void initComponents() {
        ...
        cmdedit.setText("Cancel Transaction");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelTrans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CancelTrans dialog = new CancelTrans(frmParent, true);
