...
//                        + "<tr><td><img src=" + getClass().getResource("/images/" + genderstr) + "></td><td>" + rs.getString(2) + "<br>" + "<font color=#E7C30F>Username: " + rs.getString(3) + "</font></td></th>";
    ...
    public static void reset_password(int id) {
        ...
        String pmd5 = FunctionFactory.convertMD5("");
    ...
    private void cmdresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdresetActionPerformed
        try {
            Item item = (Item) lst.getSelectedValue();
            int id = item.getId();
            int i = FunctionFactory.msgboxYesNo("Are you sure you want to reset the password this user account?");
            if (i == 0) {
                reset_password(id);
                // this.populateLst();
...
//            } else {
            int i = FunctionFactory.msgboxYesNo("Are you sure you want to delete this user account?");
            if (i == 0) {
                DeleteUser(id);
                this.populateLst();
