 ...
 * @author Engkoi Zidac
 */
public class AddElectrician extends javax.swing.JDialog {

    public static MainFrameElectrician frmParent;
    ElectricianController Controller = new ElectricianController();

    public AddElectrician(MainFrameElectrician parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddElectrician.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddElectrician dialog = new AddElectrician(frmParent, true);
